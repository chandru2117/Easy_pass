...
public class OnDuty_Form_Input extends AppCompatActivity {
    ...
    private void openButton() {
        Intent intent = new Intent(OnDuty_Form_Input.this,onduty_preview.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_duty_form_input);
